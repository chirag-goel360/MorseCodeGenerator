    ...
    def calculate(self, frame):
        ...
        if self.openEye > 50:
            ...
            if self.str is not None:
                ...
                # self.finalStringn.append(self.L)
                # self.finaln = ''.join(self.finalStringn)
                if self.str is not None:
                    stringans=self.finalString
                    # strinuque=self.finalStringn
...
def main():
    ...
    print('The Final Output is : ', stringans)
    # cap.stop()
